...
export default function SearchPage() {
  ...
  const searchQuery = useSearchWorkspaceQuery(deferredQuery, {
      ...
      <div className="max-w-4xl space-y-4">
        <div className="relative">
          ...
          <input
            ...
            className="ui-field ui-field-leading-icon min-h-11"
            autoFocus
            autoComplete="off"
        ...
        {deferredQuery.length < 2 ? (
          <DataState
            ...
            description="Enter at least two characters to find projects, tasks, members, and teams."
          />
        ) : null}
        ...
        totalResults === 0 ? (
          <DataState
            ...
            description={`Nothing matched “${deferredQuery}”. Try a project name, task title, teammate, or team.`}
          />
        ) : null}
            ...
            >
              {results.projects.map((project) => (
                <Link
                  ...
                  className="flex flex-col items-start gap-3 px-4 py-3 hover:bg-[var(--surface-muted)] sm:flex-row sm:items-center sm:justify-between"
                >
              ...
              {results.teams.map((team) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-[var(--muted)]">
                      {team.description ?? "Delivery team"}
                    </p>
                  </div>
